<?php
	...
	// 				mysqli_query($kon, "UPDATE `workout` set `vidio` = '$name', `judul` = '$judul', `durasi` = '$durasi', `deskripsi` = '$deskrip',`oleh = '$kat', `gambar` = '' WHERE `id` = '$id'") or die(mysqli_error());
...
if ($gambar_produk != "") {
  ...
  if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
    ...
    $query  = "UPDATE `workout` set `vidio` = '$name', `judul` = '$judul', `durasi` = '$durasi', `deskripsi` = '$deskrip',`oleh = '$kat', `gambar` = '' WHERE `id` = '$id'" or die(mysqli_error());
    $query .= "WHERE id = '$id'";
