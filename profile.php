<?php
	...
	if(ISSET($_POST['edit'])){
        ...
        $hapus = mysqli_query($kon, "UPDATE `adminn` set `email` = '$mail', `username` = '$nama', `password` = '$pas' WHERE `id` = '$id'") or die(mysqli_error());
		if ($hapus) {
                    ...
                    <div class="row justify-content-center">
                        ...
                        <?php
                                            ...
                                            while($data = mysqli_fetch_array($hasil,MYSQLI_ASSOC)){
                                                ...
                                                $fname = stripslashes ($data['username']);
                                                $pass = stripslashes ($data['password']);
                                                    {
                                        ?>
                                        <?php
                                        }
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="email"class="form-control form-control-user" id="mail"
                                        placeholder="Email Address" value="<?=$email?>">
                                </div>
                                <div class="form-group">
                                    <label>Fullname</label>
                                    <input type="text" name="nama"class="form-control form-control-user" id="namadepan"
                                         value="<?=$fname?>">
                                </div>
                                <div class="form-group">
                                    <label>Password</label>
                                    <input type="password" name="pass"placeholder="enter password" class="form-control form-control-user" value="<?=$pass?>"><br>
                                </div>
