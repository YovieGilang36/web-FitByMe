<?php
	...
	// 				mysqli_query($kon, "UPDATE `artikel` set `gambar` = '$name', `judul` = '$judul', `artikel` = '$kat' WHERE `id` = '$id'") or die(mysqli_error());
...
if ($gambar_produk != "") {
  ...
  if (in_array($ekstensi, $ekstensi_diperbolehkan) === true) {
    ...
    $query  = "UPDATE artikel SET gambar = '$nama_gambar_baru', judul = '$nama_produk', artikel = '$deskripsi'";
    $query .= "WHERE id = '$id'";
